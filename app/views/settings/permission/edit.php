<div class="container">
    <div class="col-lg-6 col-lg-offset-3">
        <form class="form-signin" action="<?= $data['base_url'] ?>/permission/edit/<?= Helper::getValueSecurely($data['data'], 'id', '') ?>" method="POST">
            <h2 class="form-signin-heading">Editar permiso</h2>
            ...
            <input type="text" id="controller" name="controller" class="form-control" placeholder="Controlador" required="" value="<?= Helper::getValueSecurely($data['data'], 'controller', '') ?>">
            <div>&nbsp;</div>
