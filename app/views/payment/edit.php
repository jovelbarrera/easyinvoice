<div class="container">
    <div class="col-lg-6 col-lg-offset-3">
        <form class="form-signin" action="<?= $data['base_url'] ?>/payment/edit/<?= Helper::getValueSecurely($data['data'], 'id', '') ?>" method="POST">
            <h2 class="form-signin-heading">Editar método de pago</h2>
