...
if (isset($data['error'])) {
    ...
    <div class="container">
        <div class="col-lg-12">
            <form class="form-signin" action="<?= $data['base_url'] ?>/invoice/create" method="POST">
<!--                <h2 class="form-signin-heading">Factura: Nº <?= $invoice_number ?></h2>-->
                        ...
                        <p>
                            <select id="client" name="client" class="form-control">
                                ...
                                foreach ($clients as $client) {
                                    ?>
                                    <option value="<?= Helper::getValueSecurely($client, 'id', '') ?>"
                                            ><?= Helper::getValueSecurely($client, 'name', '') ?></option>
                                            <?php
                                        }
                                        ?>
                            </select>
    ...
    <script>
        ...
        $('#add_product_button').click(function (event) {
            ...
            if (alreadyAdded) {
                alert("Ya se a agregado este producto");
            } else {
        ...
        function calculateTaxes() {
            ...
            for (section = 1; section <= dataSectionCount; section++) {
                ...
                if ($(productQuantity).val() !== undefined) {
                    percentage = 0;
                    price = 0;
